...
const Chatwidget = () => {
  ...
  useEffect(() => {
    addResponseMessage(
      `Welcome ${user.username}, I'm Sara 🤖🖐️ a bot. How can i help you today?`
    );
  }, []);
  const handleNewUserMessage = (newMessage) => {
    console.log(`New message incoming! ${newMessage}`);
    // Now send the message through the backend
    if (
      ...
      addResponseMessage(
        `Select any time slot from the calender and we will provide you an information of available vehicles then you can simple book any of them by just clicking the book now button and paying the invoice 😄`
      );
    } else if (
      ...
      addResponseMessage(`Our address is ITER, SOA University, Bhubaneswar.`);
    } else if (
      ...
      addResponseMessage(`We accept Payments from stripe only. In the checkout page, enter your details and stripe will take care of the rest.`);
      ...
      addResponseMessage(
        `You can send your number here, someone from our team will get in touch with you!`
      );
      ...
      addResponseMessage(`I'm Sara & I'm a Bot 🤖`);
    } else {
      addResponseMessage(
        `Sorry, I'm currently learning your language. I don't know the answer.`
      );
    }
  };
  return (
